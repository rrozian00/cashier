          ...
          child: SafeArea(
            child: Column(
              ...
              children: [
                ...
                // Expanded(
                //   flex: 4,
                //   child: _buildCartList(context, context.read<OrderBloc>()),
                // ),
                // _buildTotalPriceSection(context, context.read<OrderBloc>()),
                const Divider(),
                // _buildActionButtons(context, context.read<OrderBloc>()),
              ],
            ),
          ),
        ),
