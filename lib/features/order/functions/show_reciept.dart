import 'package:cashier/features/order/functions/print_reciept.dart';
...
void showReciept() {
  ...
  String storeName = controller.homeController.storeNameFinal.value;
  String address = controller.homeController.storeAddressFinal.value;
  String kasir = controller.userName.value;
  debugPrint(
      "Isi Keranjang sebelum tampilkan struk: ${controller.keranjangBelanja.toList()}");
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              children: [
                ...controller.keranjangBelanja.map((item) {
          ...
          Column(
            children: [
              ...
              _buildRow("Total", controller.totalHarga.value, bold: true),
              _buildRow("Bayar", controller.jumlahBayar.value),
              _buildRow("Kembali", controller.kembalian.value, bold: true),
            ],
          ),
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    ...
                    controller.keranjangBelanja.clear();
