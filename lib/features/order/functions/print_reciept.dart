...
Future<void> printReceipt() async {
  ...
  final storeName = controller.homeController.storeNameFinal.value;
  final storeAddress = controller.homeController.storeAddressFinal.value;
  ...
  final kasir = controller.userName.value;
  ...
  // **4. Daftar Produk**
  debugPrint(
      "Isi Keranjang: ${controller.keranjangBelanja.map((e) => e.toString()).toList()}");
  ...
  for (var item in controller.keranjangBelanja) {
